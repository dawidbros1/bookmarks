            ...
            <!-- START -->
                <div class = "w-100 fw-bold px-2 pt-1">
                    <form action = "<?=$route->get('user.update')?>" method = "post" enctype="multipart/form-data">
                        ...
                        <?php Component::render('form.submit', ['text' => "Zmień awatar", 'button' => "profile-button"])?>
                    </form>
                </div>
             <!-- END -->
            </div>
            ...
            <div class="p-3 pt-5">
                ...
                <div class="mb-3 border p-2 pt-1">
                    ...
                    <form action="<?=$route->get('user.update')?>" method="post">
                        ...
                        <?php Component::render('form.submit', ['text' => "Zmień nazwę użytkownika", 'button' => "profile-button"])?>
                    </form>
                </div>
                ...
                <div class="mb-1 border p-2 pt-1">
                    <form action="<?=$route->get('user.update')?>" method="post">
                        ...
                        <?php Component::render('form.submit', ['text' => "Aktualizuj hasło", 'button' => "profile-button"])?>
                    </form>
                </div>
            </div>
        </div>
